...
func (r Resource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	// handle creation
	res, wait, err := es.Instances.Create(ctx, plan.ProjectID.ValueString(), plan.Name.ValueString(), plan.PlanID.ValueString(), map[string]string{
...
func (r Resource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	// read instance
	i, err := es.Instances.Get(ctx, state.ProjectID.ValueString(), state.ID.ValueString())
	if err != nil {
...
func (r Resource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	// handle update
	_, process, err := es.Instances.Update(ctx, state.ProjectID.ValueString(), state.ID.ValueString(), plan.PlanID.ValueString(), map[string]string{
		"sgw_acl": strings.Join(acl, ","),
	})
	if err != nil {
...
func (r Resource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	// handle deletion
	process, err := es.Instances.Delete(ctx, state.ProjectID.ValueString(), state.ID.ValueString())
	if err != nil {
