		...
		Steps: []resource.TestStep{
			// check minimal configuration
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("stackit_mongodb_flex_instance.example", "project_id", common.ACC_TEST_PROJECT_ID),
					resource.TestCheckResourceAttr("stackit_mongodb_flex_instance.example", "version", "5"),
					...
					resource.TestCheckResourceAttrSet("stackit_mongodb_flex_instance.example", "user.hostname"),
