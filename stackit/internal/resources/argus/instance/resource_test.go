		...
		Steps: []resource.TestStep{
			// check minimal configuration
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("stackit_argus_instance.example", "otlp_traces_http_url"),
					resource.TestCheckResourceAttrSet("stackit_argus_instance.example", "otlp_traces_grpc_url"),
