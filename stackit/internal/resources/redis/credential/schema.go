...
func (r *Resource) GetSchema(_ context.Context) (tfsdk.Schema, diag.Diagnostics) {
	return tfsdk.Schema{
		Description: "Manages Redis credentials",
		Attributes: map[string]tfsdk.Attribute{
			...
			"instance_id": {
				Description: "Redis instance ID the credential belongs to",
				Type:        types.StringType,
				Required:    true,
			},
			...
			"syslog_drain_url": {
				Description: "Credential syslog drain url",
				Type:        types.StringType,
				Computed:    true,
			},

			"route_service_url": {
				Description: "Credential route service url",
				Type:        types.StringType,
				Computed:    true,
			},
