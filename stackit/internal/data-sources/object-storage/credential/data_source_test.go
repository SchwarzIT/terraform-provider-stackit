		...
		Steps: []resource.TestStep{
			// check minimal configuration
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttrPair("stackit_object_storage_credential.example", "object_storage_project_id", "data.stackit_object_storage_credential.ex1", "project_id"),
					resource.TestCheckTypeSetElemAttrPair("stackit_object_storage_credential.example", "object_storage_project_id", "data.stackit_object_storage_credential.ex2", "project_id"),
				),
			},
		},
	})
