...
func TestAcc_LogMeInstance(t *testing.T) {
		...
		Steps: []resource.TestStep{
			// check minimal configuration
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.stackit_logme_instance.example", "project_id", common.ACC_TEST_PROJECT_ID),
					...
					resource.TestCheckResourceAttrSet("data.stackit_logme_instance.example", "cf_organization_guid"),
