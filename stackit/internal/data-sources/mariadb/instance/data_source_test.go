...
func TestAcc_MariaDBInstance(t *testing.T) {
		...
		Steps: []resource.TestStep{
			// check minimal configuration
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.stackit_mariadb_instance.example", "project_id", common.ACC_TEST_PROJECT_ID),
					...
					resource.TestCheckResourceAttrSet("data.stackit_mariadb_instance.example", "cf_organization_guid"),
					resource.TestCheckTypeSetElemAttrPair("stackit_mariadb_instance.example", "id", "data.stackit_mariadb_instance.example", "id"),
					resource.TestCheckTypeSetElemAttrPair("stackit_mariadb_instance.example", "dashboard_url", "data.stackit_mariadb_instance.example", "dashboard_url"),
					resource.TestCheckTypeSetElemAttrPair("stackit_mariadb_instance.example", "cf_space_guid", "data.stackit_mariadb_instance.example", "cf_space_guid"),
					resource.TestCheckTypeSetElemAttrPair("stackit_mariadb_instance.example", "cf_organization_guid", "data.stackit_mariadb_instance.example", "cf_organization_guid"),
				),
			},
		},
	})
