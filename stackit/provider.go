...
import (
	...
	dataSecretsManager "github.com/SchwarzIT/terraform-provider-stackit/stackit/internal/data-sources/secrets-manager/instance"
...
func (p *StackitProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		resourceDataServicesCredential.NewOpensearch,
		...
		resourceDataServicesInstance.NewOpensearch,
...
func (p *StackitProvider) DataSources(context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		dataDataServicesCredential.NewOpensearch,
		...
		dataDataServicesInstance.NewOpensearch,
